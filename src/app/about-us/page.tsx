  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-4 py-5 text-[14px] text-[#777] sm:px-6 lg:px-10">
        <Link href="/" className="hover:text-[#ff3434]">Home</Link> <span className="px-2">›</span> <span>{aboutPage.breadcrumb[1]}</span>
      </div>

      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-10">
        <div className="relative h-95 overflow-hidden">
          <Image src={aboutPage.heroImage} alt="About AutoStore" fill sizes="100vw" className="object-cover" />
        </div>
        <h1 className="mt-10 text-center text-[34px] font-black uppercase text-[#222]">{aboutPage.title}</h1>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-10">
        <h2 className="mb-8 text-center text-[28px] font-black uppercase text-[#222]">Our Team Work</h2>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-10">
        <h2 className="mb-8 text-center text-[28px] font-black uppercase text-[#222]">Shop Location</h2>
