  ...
  return (
    <section className="relative overflow-hidden bg-[#0d0d0d] text-white">
      <div className="relative min-h-135 lg:min-h-155">
        ...
        <Link href={routeConfig.dailyDeals} className="absolute left-4 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white text-[#222] shadow-lg lg:left-6">‹</Link>
        <Link href={routeConfig.shop} className="absolute right-4 top-1/2 z-10 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full bg-white text-[#222] shadow-lg lg:right-6">›</Link>
